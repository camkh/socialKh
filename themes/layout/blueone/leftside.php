            ...
            <?php if ($user_type != 3) { ?>
                <li class="open">
                    ...
                    <ul class="sub-menu" style="overflow: hidden; display: block;">
                        ...
                        <?php } ?>
                        <li> <a href="<?php echo base_url(); ?>socialaccounts"> <i class="icon-bar-chart"></i>Social account</a> </li>
                        <li> <a href="<?php echo base_url(); ?>managecampaigns"> <i class="icon-bar-chart"></i>Manage campaigns</a> </li>
                    </ul>
                </li><?php }
                if ($user_type == 1):
                        ?>
